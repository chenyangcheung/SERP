...
public class NaviResultDog extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public NaviResultDog() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		savefile= ad_path+"/"+user_id+"_navi_dog.txt";
		System.out.println(savefile);
		String []evaluates=request.getParameterValues("navi_3");
		
		for(String evaluate:evaluates){
			saveAsFileWriter("navi_3(นท):"+evaluate+"ฃป ");
		}
